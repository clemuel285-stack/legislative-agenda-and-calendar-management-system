...
$pageTitle  = 'Synchronization Report';
    ...
    <main class="main-content">
        ...
        <section class="sync-page-header">
            <div>
                ...
                <h1>Executive-Legislative Synchronization Report</h1>

                <p>
                    Review synchronization candidates by legislative
                    priority and current workflow status.
                </p>
            </div>
        ...
        <div class="row g-4">
            <div class="col-xl-7">
                <section class="sync-panel h-100">
                    ...
                    <div class="sync-report-chart">
                        <canvas id="syncPriorityChart"></canvas>
                    </div>
                </section>
            </div>
                    ...
                    <div class="sync-report-list">
                        <?php if (empty($byStatus)): ?>
                            <div class="sync-empty-state compact">
                                <i class="bi bi-bar-chart"></i>
                                <strong>No synchronization data available</strong>
                            </div>
                        <?php endif; ?>
...
document.addEventListener('DOMContentLoaded', function () {
    const canvas = document.getElementById('syncPriorityChart');
