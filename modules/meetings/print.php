...
<head>
    <meta charset="UTF-8">
    <title>LACMS Meeting Coordination Queue</title>
...
<div class="print-header">
    <h3><?= e(APP_NAME) ?></h3>
    <div>Meeting Coordination Queue</div>
    ...
    <tbody>
        <?php if (empty($rows)): ?>
            <tr>
                <td colspan="8" class="text-center text-muted">
                    No coordination candidates are available.
                </td>
            </tr>
        <?php endif; ?>
        ...
        <?php foreach ($rows as $index => $row): ?>
            <tr>
                ...
                <td><?= e($row['title']) ?></td>
                <td><?= e($row['originating_office'] ?: 'Not assigned') ?></td>
